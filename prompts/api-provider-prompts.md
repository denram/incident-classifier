...
## Crie um branch dessa implementação, crie um commit semântico, faça o push e crie o pull request com a descrição do que foi implementado.
...
- O atributo com a enum IncidentCategory deverá conter as categorias de incidentes mais comuns em uma empresa.
